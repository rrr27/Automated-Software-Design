...
vBox(InterfaceNode1,i,'bint','shouldBeEmpty','',229.0,473.0).
vBox(NoteNode0,n,'n1','xxx','yyy',229.0,473.0).
...
vAssociation(A1,ClassNode3,c,'','TRIANGLE',ClassNode1,c,'','V','','','').
vAssociation(A2,InterfaceNode0,i,'','',InterfaceNode1,i,'','TRIANGLE','VHV','','').
vAssociation(A3,ClassNode3,c,'','V',InterfaceNode0,i,'','TRIANGLE','VHV','','').
vAssociation(A4,ClassNode2,c,'x','DIAMOND',ClassNode3,c,'y','','HVH','','').
vAssociation(A5,ClassNode0,c,'','BLACK_DIAMOND',ClassNode2,c,'z','','HVH','','').
vAssociation(A5,ClassNode00,c,'','BLACK_DIAMOND',ClassNode22,c,'z','','HVH','','middle').
