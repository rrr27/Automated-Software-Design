 ...
 */
public class ClassParserMac {

    static final String ClassDiagram = "com.horstmann.violet.ClassDiagramGraph";
    static final String violetSchema = "libpl/vpl.schema.pl";
    ...
    public static void main(String... args) {
        ...
        Marquee2Arguments mark = new Marquee2Arguments(ClassParserMac.class, ".class.violet", ".vpl.pl", args);
